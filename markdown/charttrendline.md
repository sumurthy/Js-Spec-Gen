...
|:---------------|:--------|:----------|:----|
|movingAveragePeriod|int|Represents the period of a chart trendline, only for trendline with MovingAvg type.|[1.9](../requirement-sets/excel-api-requirement-sets.md)|
