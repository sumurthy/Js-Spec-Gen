###
# This program reads the .CS Office pipeline definition file and generates the JSON representaiton 
# as separate files for each resources. 
# 
####
...
# Log file
	# In order to make log file not part of the repo, keep it away from the repository folders. 
	LOG_FOLDER = '../../logs'
